<?php
namespace sergmoro1\user\migrations;
...
class m180116_073828_lookup_fill extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert(static::TABLE_LOOKUP, ['name' => 'Автор',         'code' => 2, 'property_id' => self::USER_ROLE, 'position' => 2]);
        $this->insert(static::TABLE_LOOKUP, ['name' => 'Комментатор',   'code' => 3, 'property_id' => self::USER_ROLE, 'position' => 3]);
