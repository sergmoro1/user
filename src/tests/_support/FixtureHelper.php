...
namespace sergmoro1\user\tests\_support;

use sergmoro1\user\tests\common\fixtures\UserFixture;
    ...
    public function fixtures()
    {
        return [
            'user' => [
                ...
                'dataFile' => '@vendor/sergmoro1/yii2-user/src/tests/common/fixtures/data/init_login.php',
            ],
        ];
    }
}
